      ...
      <div className="container mx-auto px-4 max-w-5xl">
        ...
        <div className="grid grid-cols-2 lg:grid-cols-3 gap-3 md:gap-4">
          ...
          {[
            ...
            <div key={`s-${idx}`} className="bg-white rounded-xl p-4 md:p-6 shadow-[0_4px_20px_rgba(0,0,0,0.03)] border border-gray-100 relative overflow-hidden group hover:shadow-[0_10px_30px_rgba(0,0,0,0.06)] transition-all duration-300 flex flex-col justify-between h-full min-h-[140px] md:min-h-[160px]">
              <div className="relative z-10">
                <p className="text-xs md:text-sm font-bold text-gray-500 mb-1 leading-tight whitespace-pre-line">{item.label}</p>
                <div className="flex items-baseline gap-0.5 md:gap-1 mt-1">
                  <span className="text-4xl md:text-6xl font-black text-gray-800 tracking-tighter">{item.value}</span>
