                ...
                <div className="absolute top-0 left-0 w-16 h-1 -translate-y-1/2 bg-gradient-to-r from-blue-600 to-cyan-500 rounded-full" />
                    ...
                    <div className="space-y-10">
                      ...
                      <div className="py-12 flex justify-center">
                        ...
                        <img src="/assets/about-company/about_meta_heroes.png" alt="" className="w-full max-w-3xl h-auto" />
                  ...
                  <section>
                    ...
                    <div className="space-y-10">
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-12 py-12 items-center">
                        ...
                        <img src="/assets/about-company/experience_env_goal.png" alt="" className="w-full h-auto" />
          
                        <img src="/assets/about-company/ecosystem.png" alt="" className="w-full h-auto" />
                      ...
                      <div className="relative">
                        ...
                        <div className="flex flex-col md:flex-row items-center gap-16 relative z-10">
                          ...
                          <div className="w-full md:w-1/2 flex justify-center">
                            ...
                            <img src="/assets/about-company/strength01.png" alt="" className="w-full max-w-md h-auto" />
                      ...
                      <div className="relative">
                        ...
                        <div className="flex flex-col md:flex-row items-center gap-16 relative z-10">
                          ...
                          <div className="w-full md:w-1/2 flex justify-center">
                            ...
                            <img src="/assets/about-company/strength02.png" alt="" className="w-full max-w-md h-auto" />
                      ...
                      <div className="relative">
                        ...
                        <div className="flex flex-col md:flex-row items-center gap-16 relative z-10">
                          ...
                          <div className="w-full md:w-1/2 flex justify-center">
                            ...
                            <img src="/assets/about-company/strength03.png" alt="" className="w-full max-w-md h-auto" />
